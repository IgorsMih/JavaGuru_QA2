...
//        if ("2001".equals(year)) {
            $(yearMin).selectOptionByValue("2001");
//        } else {
//            $(yearMin).selectOptionByValue("1937");
//        }
    }
    ...
    public void validatePrice(String min, String max) {
        pressMekletButton();
        String priceMinText = $(priceMin).getAttribute("value");
        assertThat(priceMinText).isEqualTo(min);
        String priceMaxText = $(priceMax).getAttribute("value");
